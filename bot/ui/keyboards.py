...
BTN_FLASH_SHUFFLE = "\U0001F500 \u041F\u0435\u0440\u0435\u043C\u0435\u0448\u0430\u0442\u044C"
...
def create_progress_keyboard(*, can_continue: bool, show_new_topic: bool = True) -> InlineKeyboardMarkup:
    keyboard: list[list[InlineKeyboardButton]] = []
    if can_continue:
        keyboard.append([_inline_button(BTN_PROGRESS_CONTINUE, "progress:continue")])
    if show_new_topic:
        keyboard.append([_inline_button(BTN_PROGRESS_NEW_TOPIC, "progress:new_topic")])
...
def create_explanation_level_keyboard() -> InlineKeyboardMarkup:
    keyboard = [
        ...
        [_inline_button(BTN_BACK_MENU, "explain_level:menu")],
    ]
    return InlineKeyboardMarkup(inline_keyboard=keyboard)
